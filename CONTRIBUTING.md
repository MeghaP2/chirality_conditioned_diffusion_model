...
Report bugs at https://github.com/MeghaP2/chirality_aware_conformer_generation/issues.
...
chirality_aware_conformer_generation could always use more documentation, whether as part of the official docs, in docstrings, or even on the web in blog posts, articles, and such.
...
The best way to send feedback is to file an issue at https://github.com/MeghaP2/chirality_aware_conformer_generation/issues.
...
Ready to contribute? Here's how to set up chirality_aware_conformer_generation for local development.

1. Fork the chirality_aware_conformer_generation repo on GitHub.
2. Clone your fork locally:

   ```sh
   git clone git@github.com:your_name_here/chirality_aware_conformer_generation.git
   ```

3. Install your local copy with uv:

   ```sh
   cd chirality_aware_conformer_generation/
   uv sync
   ```
